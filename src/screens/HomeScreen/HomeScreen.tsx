...
export const HomeScreen = (): JSX.Element => {
  ...
  return (
    <main className="app-container mx-auto flex h-[100dvh] w-full flex-col overflow-hidden bg-white">
      ...
      <figure className="relative mx-px mt-4 min-h-0 flex-1 w-[calc(100%-2px)] overflow-hidden">
        <MapContainer
